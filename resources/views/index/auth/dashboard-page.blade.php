                                                            ...
                                                            @if ($user->id == Session::get('loginId'))
                                                                @foreach ($c->category as $cat)
                                                                    ...
                                                                    <tr class="tr1" style="vertical-align: middle">
                                                                        ...
                                                                        <td>
                                                                            <button type="button"
                                                                                class="btn btn-warning fakeBtn mb-2"><i style="color: white" class="fas fa-pen-to-square"></i></button>
                                                                            <form
                                        ...
                                        @else
                                                    ...
                                                    @foreach ($all as $users)
                                                        <tr style="vertical-align: middle">
                                                            ...
                                                            <td class="d-flex">
                                                                ...
                                                                <form action="{{ route('delete.user', $users->id) }}"
                                                                    method="Post">
                                                                    @csrf
                                                                    @method('delete')
                                                                    <button type="button"
                                            ...
                                            <div id="addProduct" style='display:none'>
                                                <form action="{{ route('add.product') }}" method="POST"
                                                    ...
                                                    <input type="text" name=name title="input product name"
                                                        placeholder="enter product name" required> <br>
                                                    <label for="desc">product description</label><br>
                                                    <textarea name="desc" id="" cols="50" rows="10" title="enter product description"
                                                        placeholder="enter product description" required></textarea><br>
                                                    <label for="image">choose product image</label><br>
                                                    <input type="file" name='image' title="choose product image"
                                                        required> <br>
                                                    <div class="discount">
                                                    ...
                                                    <input type="number" name="price" min="1"
                                                        id="" title='enter price' required><br>
                                                    <label for="quantity">quantity</label><br>
                                                    <input type="number" name="quantity" min="1"
                                                        id=""title='choose quantity' required><br>
                                                            ...
                                                            <tr style="vertical-align: middle">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="{{ route('edit.product', $p->id) }}"
                                                                        class="btn btn-warning mb-2"><i style="color: white"
                                                    ...
                                                    @foreach ($cart as $c)
                                                        @foreach ($c->user as $user)
                                                            @if ($user->id  == Session::get('loginId'))
                                                                <tr class="tr1" style="vertical-align: middle">
                                                                    ...
                                                                    @foreach ($c->product as $product)
                                                                        ...
                                                                        <td><img height="100px"
                                                                                ...
                                                                                alt=""></td>
                                                                                <td>
                                                                                    <button class="btn btn-warning fakeBtn mb-2"><i style="color:white" class="fas fa-pen-to-square"></i></button>
                                                                ...
                                                                <div style="display:none">{{ $s=1 }}</div>
                                                                <tr class="tr2" style="display:none">
                                                                    ...
                                                                    <td><input type="number" name="quantity" value="{{$c->quantity}}"  name="" id="" min="1"></td>
                                                                    <td>
                                                                        <button class="btn btn-warning updateCart"><i class="fas fa-check"></i></button>
                                                                    </form>
                                                                        <button class="btn btn-success cUpCart"><i class="fas fa-xmark"></i></button>
                                                                    </td>
                                                                </tr>
                                                            @endif
                                                        @endforeach
